...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				//TODO: Registrar al huesped y guardar la reservarcion y huesped en la bd.
				//TODO: Informar si existe algun error al usuario.
				String fechaNacimiento = String.valueOf(txtFechaN.getCalendar().get(Calendar.YEAR)) + "-" + String.valueOf(txtFechaN.getCalendar().get(Calendar.MONTH)+1)+"-"+String.valueOf(txtFechaN.getCalendar().get(Calendar.DAY_OF_MONTH));
				Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechaNacimiento, txtNacionalidad.getSelectedItem().toString(), Integer.parseInt(txtTelefono.getText()), Integer.parseInt(txtNreserva.getText()));
