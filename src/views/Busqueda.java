...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(!txtBuscar.getText().isEmpty()) {
					if (scroll_tableHuespedes.isVisible()) {
						...
						List<Huespedes> huespedes = huespedesController.buscar(txtBuscar.getText());
					...
					if (scroll_table.isVisible()) {
						limpiarTablaReserva();
						List<Reservas> reservas = reservasController.buscar(txtBuscar.getText());
				...
				if (scroll_table.isVisible()) {
			        ...
			        Optional.ofNullable(modelo.getValueAt(tbReservas.getSelectedRow(), tbReservas.getSelectedColumn()))
			                .ifPresentOrElse(fila -> {		                    
			                    ...
			                    Integer filasModificadas = reservasController.modificar(id, fecha_Entrada, fecha_Salida, valor, forma_Pago);
			                    
			                    JOptionPane.showMessageDialog(null, String.format("%d item modificado con éxito!", filasModificadas));
			                }, () -> JOptionPane.showMessageDialog(null, "Por favor, elije un item"));
				}
				...
				if (scroll_tableHuespedes.isVisible()) {
			        ...
			        Optional.ofNullable(modeloHuesped.getValueAt(tbHuespedes.getSelectedRow(), tbHuespedes.getSelectedColumn()))
			                .ifPresentOrElse(fila -> {
			                    ...
			                    Integer filasModificadas = huespedesController.modificar(id, nombre, apellido, fecha_Nacimiento, nacionalidad, telefono, id_Reserva);
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (scroll_table.isVisible()) {//Reserva
					if (tieneFilaElegidaReserva()) {
			            JOptionPane.showMessageDialog(null, "Por favor, elije un item");
			            return;
			        }
	                ...
	                .ifPresentOrElse(fila -> {
	                    ...
	                    Integer filasModificadas = reservasController.eliminar(id);
				...
				if (scroll_tableHuespedes.isVisible()) {
	                ...
	                .ifPresentOrElse(fila -> {
	                    ...
	                    Integer filasModificadas = huespedesController.eliminar(id);
	...
	private void cargarTablaReserva() {
		...
		reservas.forEach(reserva -> modelo.addRow(new Object[] { reserva.getId(), reserva.getFecha_Entrada(),
